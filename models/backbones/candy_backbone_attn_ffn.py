...
class CandyNetBackboneAttnFFN(BaseBackbone):
    """CannyNet backbone."""
    ...
    def build_stage_layer(self, stage_idx: int, setting: list):
        ...
        if not use_attn:
            ...
            from models.layers.efficient_attention import EfficientAttentionFFN

            blocks = nn.Sequential(
                *[
                    EfficientAttentionFFN(
                        model_dim=out_channels,
                        key_dim=out_channels, 
