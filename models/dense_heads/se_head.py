...
from mmdet.utils import OptMultiConfig, ConfigType, OptConfigType, OptInstanceList
...
from models.utils.misc import make_divisible, gt_instances_preprocess




@MODELS.register_module()
class SEHeadModule(BaseModule):
    ...
    def _init_layers(self):
        ...
        for i in range(self.num_levels):
            self.reg_preds.append(
                nn.Sequential(
                    SELayer(channels=self.in_channels[i]),
                    ConvModule(
