...
class BaseAlgorithm(BaseModel):
    ...
    def __init__(self,
        ...
        if isinstance(architecture, Dict):
            arch_cfg_path = architecture['cfg_path']
            # arch_pretrained = architecture['pretrained']
            arch_cfg =Config.fromfile(filename=arch_cfg_path)
            architecture = MODELS.build(arch_cfg['model'])
