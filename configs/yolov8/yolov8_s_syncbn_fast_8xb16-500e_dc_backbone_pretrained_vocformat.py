...
# -----data related-----
data_root = "data/Diverse_Weather_Dataset/daytime_clear/"  # Root path of data

# Path of train annotation file
train_ann_file = "VOC2007/ImageSets/Main/train.txt"
train_data_prefix = dict(sub_data_root='VOC2007/')  # Prefix of train image path

# Path of val annotation file
val_ann_file = "VOC2007/ImageSets/Main/train.txt"
val_data_prefix = dict(sub_data_root='VOC2007/')  # Prefix of val image path

# Path of test annotation file
# ['daytime_clear', 'daytime_foggy', 'dusk_rainy', 'night_rainy', 'Night-Sunny']
test_data_root = "data/Diverse_Weather_Dataset/daytime_clear/"
test_ann_file = "VOC2007/ImageSets/Main/train.txt"
test_data_prefix = dict(sub_data_root='VOC2007/')  # Prefix of test image path
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type="Pretrained",
            checkpoint="checkpoints/yolov8_s_syncbn_fast_8xb16-500e_coco_backbone/best_coco_bbox_mAP_epoch_470.pth",
            prefix="backbone",
        ),
    ),
    neck=dict(
