...
custom_imports = dict(
    imports=[
        "models.backbones.yolov10_backbone",
        "models.necks.yolov10_pafpn",
        "models.dense_heads.yolov10_head",
    ],
...
train_ann_file = "voc07_train.json"
...
test_ann_file = "voc07_train.json"
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type="Pretrained", checkpoint="checkpoints/yolov10n.pt", prefix="backbone"
        ),
    ),
    neck=dict(
        type="YOLOv10PAFPN",
        ...
        act_cfg=dict(type="SiLU", inplace=True),
        init_cfg=dict(
            type="Pretrained", checkpoint="checkpoints/yolov10n.pt", prefix="neck"
        ),
    ),
    bbox_head=dict(
        type="YOLOv10Head",
    ...
    init_cfg=dict(
            type="Pretrained", checkpoint="checkpoints/yolov10n.pt", prefix="bbox_head"
        ),
)
